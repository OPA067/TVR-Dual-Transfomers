...
class MSRVTTDataset(Dataset):
    ...
    def __init__(self, config: Config, split_type='train', img_transforms=None):
        ...
        test_file_pth = '/MSRVTT_test.1000.csv'
        test_csv = dir + test_file_pth

        # train_csv = dir + '/MSRVTT_train.1000.csv'
        train_csv = dir + '/MSRVTT_train.9000.csv'
    ...
    def _construct_all_train_pairs(self):
        ...
        print("train/test len is", len(self.all_train_pairs))
